...
public:
	...
	MulticastEvent<Button*> OnMouseHoverEvent;
	MulticastEvent<Button*> OnMouseLeaveEvent;
	...
	virtual void OnMouseLeave() { bPressed = false; OnMouseLeaveEvent(this); };
	virtual void OnMouseHover() { OnMouseHoverEvent(this); };
